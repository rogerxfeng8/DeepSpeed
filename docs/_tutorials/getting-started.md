...
* DeepSpeed supports Intel Architecture Xeon CPU, Intel Data Center Max Series XPU, Intel Gaudi HPU, Huawei Ascend NPU etc, please see the [accelerator setup guide](tutorials/accelerator-setup-guide/)
